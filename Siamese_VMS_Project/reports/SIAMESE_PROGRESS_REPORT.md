...
> **Historical snapshot - the architecture below is superseded.** Kept as a dated
> record of Phases 1-2 and deliberately not rewritten. The production system has since
> moved to a trained attentive-pooling head on frozen WavLM L10 (not wav2vec2 + L2
> distance as described here), transcript-guarded self-calibration, and rival-anchor
> verification. Current mechanics: `reports/ARCHITECTURE.md`. Current results:
